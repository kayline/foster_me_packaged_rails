...
ActiveRecord::Schema.define(version: 2018_09_16_020450) do
  ...
  create_table "foster_families", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_foster_families_on_user_id"
  end
  ...
  create_table "weight_measurements", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["animal_id"], name: "index_weight_measurements_on_animal_id"
  end

  add_foreign_key "foster_families", "users"
end
